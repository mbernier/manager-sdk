...
class VendorProductOptionsApiGetListVendor(object):

    """Implementation of the 'VendorProductOptionsApi.get_list.Vendor' model.
    ...
    def __init__(self,
        ...
        """Constructor for the VendorProductOptionsApiGetListVendor class"""
