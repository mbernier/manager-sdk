...
from manager.models.vendor_api_get import VendorApiGet


class VendorResponse3(object):

    """Implementation of the 'Vendor Response3' model.
    ...
    Attributes:
        ...
        result (VendorApiGet): TODO: type description here.
    ...
    def __init__(self,
                 ...
                 show_columns=None,
                 show_title=None):
        """Constructor for the VendorResponse3 class"""
    ...
    def from_dictionary(cls,
        ...
        result = VendorApiGet.from_dictionary(dictionary.get('result')) if dictionary.get('result') else None
