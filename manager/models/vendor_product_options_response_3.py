...
from manager.models.vendor_product_options_api_get import VendorProductOptionsApiGet


class VendorProductOptionsResponse3(object):

    """Implementation of the 'Vendor Product Options Response3' model.
    ...
    Attributes:
        ...
        result (VendorProductOptionsApiGet): TODO: type description here.
    ...
    def __init__(self,
                 ...
                 show_columns=None,
                 show_title=None):
        """Constructor for the VendorProductOptionsResponse3 class"""
    ...
    def from_dictionary(cls,
        ...
        result = VendorProductOptionsApiGet.from_dictionary(dictionary.get('result')) if dictionary.get('result') else None
