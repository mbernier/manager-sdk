...
class VendorShippingApiGetListVendor(object):

    """Implementation of the 'VendorShippingApi.get_list.Vendor' model.
    ...
    def __init__(self,
        ...
        """Constructor for the VendorShippingApiGetListVendor class"""
