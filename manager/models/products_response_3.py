...
from manager.models.products_api_get import ProductsApiGet


class ProductsResponse3(object):

    """Implementation of the 'Products Response3' model.
    ...
    Attributes:
        ...
        result (ProductsApiGet): TODO: type description here.
    ...
    def __init__(self,
                 ...
                 show_columns=None,
                 show_title=None):
        """Constructor for the ProductsResponse3 class"""
    ...
    def from_dictionary(cls,
        ...
        result = ProductsApiGet.from_dictionary(dictionary.get('result')) if dictionary.get('result') else None
