...
from manager.models.websites_api_get import WebsitesApiGet


class WebsitesResponse3(object):

    """Implementation of the 'Websites Response3' model.
    ...
    Attributes:
        ...
        result (WebsitesApiGet): TODO: type description here.
    ...
    def __init__(self,
                 ...
                 show_columns=None,
                 show_title=None):
        """Constructor for the WebsitesResponse3 class"""
    ...
    def from_dictionary(cls,
        ...
        result = WebsitesApiGet.from_dictionary(dictionary.get('result')) if dictionary.get('result') else None
