...
class ProductsApiGetWebsitesProducts(object):

    """Implementation of the 'ProductsApi.get.WebsitesProducts' model.
    ...
    def __init__(self,
                 changed_on=None,
                 created_on=None):
        """Constructor for the ProductsApiGetWebsitesProducts class"""
