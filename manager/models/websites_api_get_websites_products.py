...
class WebsitesApiGetWebsitesProducts(object):

    """Implementation of the 'WebsitesApi.get.WebsitesProducts' model.
    ...
    def __init__(self,
                 changed_on=None,
                 created_on=None):
        """Constructor for the WebsitesApiGetWebsitesProducts class"""
