...
from manager.models.product_notes_api_get_list import ProductNotesApiGetList


class ProductNotesResponse(object):

    """Implementation of the 'Product Notes Response' model.
    ...
    Attributes:
        ...
        result (list of ProductNotesApiGetList): The result from the get list
            query
    ...
    def __init__(self,
                 ...
                 order_columns=None,
                 result=None):
        """Constructor for the ProductNotesResponse class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('result') is not None:
            result = [ProductNotesApiGetList.from_dictionary(x) for x in dictionary.get('result')]
