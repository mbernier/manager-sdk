...
from manager.models.vendor_contact_api_get import VendorContactApiGet


class VendorContactResponse3(object):

    """Implementation of the 'Vendor Contact Response3' model.
    ...
    Attributes:
        ...
        result (VendorContactApiGet): TODO: type description here.
    ...
    def __init__(self,
                 ...
                 show_columns=None,
                 show_title=None):
        """Constructor for the VendorContactResponse3 class"""
    ...
    def from_dictionary(cls,
        ...
        result = VendorContactApiGet.from_dictionary(dictionary.get('result')) if dictionary.get('result') else None
