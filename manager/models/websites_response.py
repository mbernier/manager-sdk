...
from manager.models.websites_api_get_list import WebsitesApiGetList


class WebsitesResponse(object):

    """Implementation of the 'Websites Response' model.
    ...
    Attributes:
        ...
        result (list of WebsitesApiGetList): The result from the get list
            query
    ...
    def __init__(self,
                 ...
                 order_columns=None,
                 result=None):
        """Constructor for the WebsitesResponse class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('result') is not None:
            result = [WebsitesApiGetList.from_dictionary(x) for x in dictionary.get('result')]
