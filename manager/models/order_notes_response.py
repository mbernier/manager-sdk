...
from manager.models.order_notes_api_get_list import OrderNotesApiGetList


class OrderNotesResponse(object):

    """Implementation of the 'Order Notes Response' model.
    ...
    Attributes:
        ...
        result (list of OrderNotesApiGetList): The result from the get list
            query
    ...
    def __init__(self,
                 ...
                 order_columns=None,
                 result=None):
        """Constructor for the OrderNotesResponse class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('result') is not None:
            result = [OrderNotesApiGetList.from_dictionary(x) for x in dictionary.get('result')]
