...
# Vendor Product Options Response

## Structure

`VendorProductOptionsResponse`
...
| `result` | [`List of VendorProductOptionsApiGetList`](/doc/models/vendor-product-options-api-get-list.md) | Optional | The result from the get list query |
