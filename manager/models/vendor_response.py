...
from manager.models.vendor_api_get_list import VendorApiGetList


class VendorResponse(object):

    """Implementation of the 'Vendor Response' model.
    ...
    Attributes:
        ...
        result (list of VendorApiGetList): The result from the get list query
    ...
    def __init__(self,
                 ...
                 order_columns=None,
                 result=None):
        """Constructor for the VendorResponse class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('result') is not None:
            result = [VendorApiGetList.from_dictionary(x) for x in dictionary.get('result')]
