...
from manager.models.order_notes_api_get import OrderNotesApiGet


class OrderNotesResponse3(object):

    """Implementation of the 'Order Notes Response3' model.
    ...
    Attributes:
        ...
        result (OrderNotesApiGet): TODO: type description here.
    ...
    def __init__(self,
                 ...
                 show_columns=None,
                 show_title=None):
        """Constructor for the OrderNotesResponse3 class"""
    ...
    def from_dictionary(cls,
        ...
        result = OrderNotesApiGet.from_dictionary(dictionary.get('result')) if dictionary.get('result') else None
