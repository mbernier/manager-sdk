...
from manager.models.vendor_shipping_api_get_list import VendorShippingApiGetList


class VendorShippingResponse(object):

    """Implementation of the 'Vendor Shipping Response' model.
    ...
    Attributes:
        ...
        result (list of VendorShippingApiGetList): The result from the get
            list query
    ...
    def __init__(self,
                 ...
                 order_columns=None,
                 result=None):
        """Constructor for the VendorShippingResponse class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('result') is not None:
            result = [VendorShippingApiGetList.from_dictionary(x) for x in dictionary.get('result')]
