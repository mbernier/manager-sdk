...
"""
from manager.models.customer_api_get import CustomerApiGet
from manager.models.description_columns import DescriptionColumns
from manager.models.label_columns import LabelColumns


class CustomerResponse3(object):

    """Implementation of the 'Customer Response3' model.
    ...
    Attributes:
        ...
        result (CustomerApiGet): TODO: type description here.
    ...
    def __init__(self,
                 ...
                 show_columns=None,
                 show_title=None):
        """Constructor for the CustomerResponse3 class"""
    ...
    def from_dictionary(cls,
        ...
        result = CustomerApiGet.from_dictionary(dictionary.get('result')) if dictionary.get('result') else None
