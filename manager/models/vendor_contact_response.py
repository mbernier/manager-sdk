...
from manager.models.vendor_contact_api_get_list import VendorContactApiGetList


class VendorContactResponse(object):

    """Implementation of the 'Vendor Contact Response' model.
    ...
    Attributes:
        ...
        result (list of VendorContactApiGetList): The result from the get list
            query
    ...
    def __init__(self,
                 ...
                 order_columns=None,
                 result=None):
        """Constructor for the VendorContactResponse class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('result') is not None:
            result = [VendorContactApiGetList.from_dictionary(x) for x in dictionary.get('result')]
