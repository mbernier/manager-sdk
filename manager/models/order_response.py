...
from manager.models.order_api_get_list import OrderApiGetList


class OrderResponse(object):

    """Implementation of the 'Order Response' model.
    ...
    Attributes:
        ...
        result (list of OrderApiGetList): The result from the get list query
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('result') is not None:
            result = [OrderApiGetList.from_dictionary(x) for x in dictionary.get('result')]
