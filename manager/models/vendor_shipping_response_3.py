...
from manager.models.vendor_shipping_api_get import VendorShippingApiGet


class VendorShippingResponse3(object):

    """Implementation of the 'Vendor Shipping Response3' model.
    ...
    Attributes:
        ...
        result (VendorShippingApiGet): TODO: type description here.
    ...
    def __init__(self,
                 ...
                 show_columns=None,
                 show_title=None):
        """Constructor for the VendorShippingResponse3 class"""
    ...
    def from_dictionary(cls,
        ...
        result = VendorShippingApiGet.from_dictionary(dictionary.get('result')) if dictionary.get('result') else None
