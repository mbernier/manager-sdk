...
from manager.models.products_api_get_list import ProductsApiGetList


class ProductsResponse(object):

    """Implementation of the 'Products Response' model.
    ...
    Attributes:
        ...
        result (list of ProductsApiGetList): The result from the get list
            query
    ...
    def __init__(self,
                 ...
                 order_columns=None,
                 result=None):
        """Constructor for the ProductsResponse class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('result') is not None:
            result = [ProductsApiGetList.from_dictionary(x) for x in dictionary.get('result')]
